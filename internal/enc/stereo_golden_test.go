...
// combinations the encoder can reach, because it skips nmrDecideStereo when
// both are off (the guard at the call site, aacenc.c:1216-1217), which is why
// there is no "neither" fixture. Until issue #92 only the defaults were
